main_category = Category.create({ title: 'Про Rails', description: 'Фреймворк, написанный на Ruby' })

Post.create([{
                title: 'Переписываем проект с Rails на Django',
                author: 'Гарри Поттер',
                image: 'django',
                category_id: main_category.id
             }, {
               title: 'Выбрасываем из Rails лишнее',
